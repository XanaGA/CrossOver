...
from third_parties.salad.utils import get_loss, get_miner, get_validation_recalls
from third_parties.salad.models import helper
...
class VPRModel(pl.LightningModule):
    ...
    def __init__(self,
        #---- Backbone
        backbone_arch: Union[str, torch.nn.Module] = 'resnet50',
        backbone_config={},
