...
def discrete_cmap():
    ...
    # define individual colors as hex values for rooms_furu
    cpool = ['#DCDCDC', '#b3de69', '#000000', '#8dd3c7', '#fdb462',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
    ...
    # define individual colors as hex values for icons_furu
    cpool = ['#DCDCDC', '#8dd3c7', '#b15928', '#fdb462', '#ffff99',
             '#fccde5', '#80b1d3', '#808080', '#fb8072', '#696969',
             '#577a4d']
    cmap3 = colors.ListedColormap(cpool, 'icons_furu')
    plt.colormaps.register(cmap3, force=True)
